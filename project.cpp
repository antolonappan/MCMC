...
float chi_sq[3][1000000] ={},A[3][1000000] ={},B[3][1000000] ={},C[3][1000000] ={},x[25]={},y[25]={};
...
int chain(int itr)
	{
  	...
  	ifstream inX(xdata);
        ...
        while(!inY.eof() && i<25 )
         ...
         uniform_real_distribution<double> od(0, 1);    
...
//////////////////////////////////////////////////////////////////////////////////////////
	 	 ...
	 	 float  theta_bar_3_a = sa/(N/2);
  	         float  theta_bar_3_b = sb/(N/2);
	         float  theta_bar_3_c = sc/(N/2);
///////////////////////////////////////////////////////////////////////////////////////////	



	           theta_bar_a = (theta_bar_1_a + theta_bar_2_a + theta_bar_3_a) / M;	
	           theta_bar_b = (theta_bar_1_b + theta_bar_2_b + theta_bar_3_b) / M;
	           theta_bar_c = (theta_bar_1_c + theta_bar_2_c + theta_bar_3_c) / M;
                   //theta_bar_d = (theta_bar_1_d + theta_bar_2_d) / M;
                   //theta_bar_e = (theta_bar_1_e + theta_bar_2_e) / M;
	           
                   B_a = pow((theta_bar_1_a - theta_bar_a),2) + pow((theta_bar_2_a - theta_bar_a),2) + pow((theta_bar_3_a - theta_bar_a),2);
	           B_b = pow((theta_bar_1_b - theta_bar_b),2) + pow((theta_bar_2_b - theta_bar_b),2) + pow((theta_bar_3_b - theta_bar_b),2);
	           B_c = pow((theta_bar_1_c - theta_bar_c),2) + pow((theta_bar_2_c - theta_bar_c),2) + pow((theta_bar_3_c - theta_bar_c),2);
		  ...
		  S_2_af = S_2_a/((N/2)-1);
	          ...
	          S_2_cf = S_2_c/((N/2)-1);
                 // S_2_df = S_2_d/((N/2)-1);
                 // S_2_ef = S_2_e/((N/2)-1);
float S_3_a,S_3_b,S_3_c,S_3_af,S_3_bf,S_3_cf;
///////////////////////////////////////////////////////////////////////////////////////////////////////
                for(int l = (en/2); l<=en; l++)
 			{
			 Sa =pow( (A[3][l] - theta_bar_3_a),2);
			 S_3_a = S_3_a + Sa;
                
			 Sb =pow( (B[3][l] - theta_bar_3_b),2);
			 S_3_b = S_3_b + Sb;
          
                         Sc =pow( (C[3][l] - theta_bar_3_c),2);
			 S_3_c = S_3_c + Sc; 
                        /* Sd =pow( (D[1][l] - theta_bar_2_d),2);
			 S_2_d = S_2_d + Sd; 
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
  	   	  ...
  	   	  Wa = (S_1_af + S_2_af + S_3_af)/M;
	          Wb = (S_1_bf + S_2_bf + S_2_bf)/M;
	          Wc = (S_1_cf + S_2_cf + S_2_cf)/M;
                 // Wd = (S_1_df + S_2_df)/2;
	         // We = (S_1_ef + S_2_ef)/2;
...
printv.close();
	 ...
	 print.open("chain2.csv");
		...
		print.close();
print.open("chain3.csv");
		print<<"#chisq,#a,#b,#c\n";

	        for(int i=1; i<100000; i++)
			 {
			  print<<chi_sq[2][i]<<","<<A[2][i]<<","<<B[2][i]<<","<<C[2][i]<<"\n";
     			 if (i>3 &&  chi_sq[0][i]==0 && A[0][i]==0 ) 
                         {
                        break;
                         }
